...
export const createEncryptionUtils = (ENCRYPTION_KEY: string) => {
    const compressAndEncrypt = (input: string, useIV: boolean = true): string => {
    ...
    const decryptAndDecompress = (input: string, useIV: boolean = true): string => {
